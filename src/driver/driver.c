 ...
 *
 * This address of this variable will be same as start and end
 ...
 * last.
 *
 * @return - returns the execution status of all driver_exit
 *           in "or" method
 */
 ...
 *
 * This function parses all the drivers in table and compares
 * the name of driver to be executed. On successful match, the
 * driver_setup is called.
 *
 * @*name - Take name of driver (string) as argument
 * @return - return the execution status of driver_setup
 */
 ...
 *
 * @*name - Take name of driver (string) as argument
 * @return - return the execution status of driver_exit
 */
 ...
 *
 * Function not implemented yet. The correct way to call this
