...
/**@{ */
    ...
    #define PTHREAD_COND_INITIALIZER    CC_POSIX_COND_INITIALIZER       /**< pthread_cond_t. */
#endif

#if posixconfigENABLE_PTHREAD_MUTEX_T == 1
    #define PTHREAD_MUTEX_INITIALIZER    CC_POSIX_MUTEX_INITIALIZER /**< pthread_mutex_t. */
#endif
 ...
 * @retval ENOMEM - count cannot fit into Kernel event group type OR insufficient memory exists to initialize the barrier.
 *
